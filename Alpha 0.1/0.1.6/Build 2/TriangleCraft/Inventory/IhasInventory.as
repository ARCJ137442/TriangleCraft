package TriangleCraft.Inventory
{
	...
	public interface IhasInventory
	{
		...
		//set
		//----Main Methods----//
		function addItem(id:TileID,count:uint=1,data:int=0):void
		function removeItem(id:TileID,count:uint=1,data:int=0):void
		function hasItemIn(id:TileID,count:uint=1,data:int=0):Boolean
	}
}