package TriangleCraft.Tile
{
	...
	public class TileSystem
	{
		...
		public static const AllInternalBlockID:Vector.<String>=new <String>[
			TileID.Void,
		...
		public static const AllInternalItemID:Vector.<String>=new <String>[]
		public static var AllCustomBlockID:Vector.<String>=new <String>[]
		public static var AllCustomItemID:Vector.<String>=new <String>[]
		...
		public static function get AllItemID():Vector.<String>
		{
			return TileSystem.AllInternalItemID.concat(TileSystem.AllCustomItemID)
		}
		
		public static function get AllInternalTileID():Vector.<String>
		{
			return TileSystem.AllInternalBlockID.concat(TileSystem.AllInternalItemID)
		}
		
		public static function get AllCustomTileID():Vector.<String>
		{
