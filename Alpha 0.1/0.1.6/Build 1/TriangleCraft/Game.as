package TriangleCraft
{
	...
	public class Game extends Sprite
	{
		...
		public static const VERSION:String="Alpha 0.1.6 build 1";
		...
		protected function initAllTile():void
		{
			...
			addCraftRecipe("vvv","vvv","vvv",[],
						   "vvv","vbv","vvv",["b","example",0,0])*/
		}

		protected function initDefaultRecipes():void
		{
			//Color Mixer
			addCraftRecipe("gbg","bbb","gbg",["g",TileID.Colored_Block,0x8888880,0,
											  "b",TileID.Colored_Block,0x0000000,0],
						   "vvv","vav","vvv",["a",TileID.Color_Mixer,0,0])
			//Block Crafter
			addCraftRecipe("ggg","bgb","ggg",["g",TileID.Colored_Block,0x8888880,0,
											  "b",TileID.Colored_Block,0x0000000,0],
						   "vvv","vav","vvv",["a",TileID.Block_Crafter,0,0])
			//Bacic Wall
			addCraftRecipe("bbb","bgb","bbb",["b",TileID.Colored_Block,0x0000000,0,
											  "g",TileID.Colored_Block,0x8888880,0],
						   "gag","aaa","gag",["a",TileID.Basic_Wall,0,0,
											  "g",TileID.Colored_Block,0x8888880,0])
			//Crystal Wall
			addCraftRecipe("ccc","cwc","ccc",["w",TileID.Basic_Wall,0,0,
											  "c",TileID.Colored_Block,0x00ffff0,0],
						   "vwv","vwv","vwv",["w",TileID.Crystal_Wall,0,0])
			//Block Spawner
			addCraftRecipe("bgb","ggg","bgb",["b",TileID.Colored_Block,0x0000000,0,
											  "g",TileID.Colored_Block,0x8888880,0],
						   "vvv","vav","vvv",["a",TileID.Block_Spawner,0,0])
			//Walls Spawner
			addCraftRecipe("bwb","wsw","bwb",["b",TileID.Colored_Block,0x0000000,0,
											  "w",TileID.Basic_Wall,0,0,
											  "s",TileID.Block_Spawner,0,0],
						   "vvv","vav","vvv",["a",TileID.Walls_Spawner,0,0])
			//Arrow Block
			addCraftRecipe("bbv","ggb","bbv",["b",TileID.Colored_Block,0x0000000,0,
											  "g",TileID.Colored_Block,0x8888880,0],
						   "vvv","aaa","vvv",["a",TileID.Arrow_Block,0,0])
			//Pushable Block Black
			addCraftRecipe("bbb","bvb","bbb",["b",TileID.Colored_Block,0x0000000,0],
						   "vbv","vvv","vbv",["b",TileID.Pushable_Block,0,0])
			//Pushable Block Red
			addCraftRecipe("bbb","bvb","bbb",["b",TileID.Colored_Block,0xff00000,0],
						   "vbv","vvv","vbv",["b",TileID.Pushable_Block,10,0])
			//Pushable Block Yellow
			addCraftRecipe("bbb","bvb","bbb",["b",TileID.Colored_Block,0xffff000,0],
						   "vbv","vvv","vbv",["b",TileID.Pushable_Block,20,0])
			//Pushable Block Green
			addCraftRecipe("bbb","bvb","bbb",["b",TileID.Colored_Block,0x00ff000,0],
						   "vbv","vvv","vbv",["b",TileID.Pushable_Block,30,0])
			//Pushable Block Cyan
			addCraftRecipe("bbb","bvb","bbb",["b",TileID.Colored_Block,0x00ffff0,0],
						   "vbv","vvv","vbv",["b",TileID.Pushable_Block,40,0])
			//Pushable Block Blue
			addCraftRecipe("bbb","bvb","bbb",["b",TileID.Colored_Block,0x0000ff0,0],
						   "vbv","vvv","vbv",["b",TileID.Pushable_Block,50,0])
			//Pushable Block Pink
			addCraftRecipe("bbb","bvb","bbb",["b",TileID.Colored_Block,0xff00ff0,0],
			...
			//XX Virus
			addCraftRecipe("bgb","gsg","bgb",["b",TileID.Colored_Block,0x0000000,0,
											  "g",TileID.Colored_Block,0x8888880,0,
											  "s",TileID.Block_Spawner,0,0],
						   "vvv","vvv","vvv",["v",TileID.XX_Virus,0,0])
			//XX Virus Red
			addCraftRecipe("vvv","vrv","vvv",["r",TileID.Colored_Block,0xff00000,0,
											  "v",TileID.XX_Virus,0,0],
						   "vvv","vvv","vvv",["v",TileID.XX_Virus_Red,0,0])
			//XX Virus Green
			addCraftRecipe("vvv","vbv","vvv",["b",TileID.Colored_Block,0x00ff000,0,
											  "v",TileID.XX_Virus,0,0],
						   "vvv","vvv","vvv",["v",TileID.XX_Virus_Green,0,0])
			//XX Virus Blue
			addCraftRecipe("vvv","vbv","vvv",["b",TileID.Colored_Block,0x0000ff0,0,
											  "v",TileID.XX_Virus,0,0],
						   "vvv","vvv","vvv",["v",TileID.XX_Virus_Blue,0,0])
			//XX Virus Cyan
			addCraftRecipe("vvv","vbv","vvv",["b",TileID.Colored_Block,0x00ffff0,0,
											  "v",TileID.XX_Virus,0,0],
						   "vvv","vvv","vvv",["v",TileID.XX_Virus_Cyan,0,0])
			//XX Virus Purple
			addCraftRecipe("vvv","vbv","vvv",["b",TileID.Colored_Block,0xff00ff0,0,
											  "v",TileID.XX_Virus,0,0],
						   "vvv","vvv","vvv",["v",TileID.XX_Virus_Purple,0,0])
			//XX Virus Yellow
			addCraftRecipe("vvv","vbv","vvv",["b",TileID.Colored_Block,0xffff000,0,
											  "v",TileID.XX_Virus,0,0],
						   "vvv","vvv","vvv",["v",TileID.XX_Virus_Yellow,0,0])
			//XX Virus Black
			addCraftRecipe("vvv","vbv","vvv",["b",TileID.Colored_Block,0x0000000,0,
											  "v",TileID.XX_Virus,0,0],
						   "vvv","vvv","vvv",["v",TileID.XX_Virus_Black,0,0])
			//Signal Wire
			addCraftRecipe("vbv","bbb","vbv",["b",TileID.Colored_Block,0x0000000,0],
			...
			addCraftRecipe("wbw","bab","wbw",["w",TileID.Basic_Wall,0,0,
											  "b",TileID.Signal_Wire,0,0,
											  "a",TileID.Colored_Block,0x0000000,0],
			...
			addCraftRecipe("wbw","bab","wbw",["w",TileID.Basic_Wall,0,0,
						   ...
						   "svs","vbv","svs",["s",TileID.Signal_Byte_Pointer,0,0,
											  "b",TileID.Colored_Block,0x8888880,0],
						   true,true,false,true)
			//Signal Byte Getter
			...
			addCraftRecipe("wbd","bad","wbd",["w",TileID.Basic_Wall,0,0,
											  "b",TileID.Signal_Wire,0,0,
											  "a",TileID.Arrow_Block,0,0,
											  "d",TileID.Colored_Block,0x0000ff0,0],
			...
			addCraftRecipe("wbd","bad","wbd",["w",TileID.Basic_Wall,0,0,
											  "b",TileID.Signal_Wire,0,0,
											  "a",TileID.Arrow_Block,0,0,
											  "d",TileID.Colored_Block,0x00ff000,0],
			...
			addCraftRecipe("wbd","bad","wbd",["w",TileID.Basic_Wall,0,0,
											  "b",TileID.Signal_Wire,0,0,
											  "a",TileID.Arrow_Block,0,0,
											  "d",TileID.Colored_Block,0xff00000,0],
				...
				if(player.isSelectItem&&player.ability.canPlace&&Place)
				{
					...
					if(!hasEntityOn(frontX,frontY)&&block!=null)
					{
						   ...
						   blockAttributes.canPlaceBy)
						{
							...
							this.UpdateDebugText(2);
							//Set Hook
							onPlayerPlaceBlock(player,frontX,frontY,Rot,PlaceId,PlaceData,PlaceRot,TileSystem.getHardnessFromID(PlaceId));
						}
						else if(player.selectedItem.count>0&&player.ability.canUseItem)
						{
							//Use Item
							onPlayerUseItem(player,frontX,frontY,Rot,PlaceId,PlaceData,PlaceRot,TileSystem.getHardnessFromID(PlaceId));
						}
					}
				}
			}
		...
		public function summonItem(X:Number,Y:Number,
								 ...
								 Count:uint=1,Data:int=0,Rot:int=0,
								 xd:Number=NaN,yd:Number=NaN,vr:Number=NaN):TriangleCraft.Entity.EntityItem
		{
			var item:TriangleCraft.Entity.EntityItem=new TriangleCraft.Entity.EntityItem(this,X*TILE_SIZE,Y*TILE_SIZE,Id,Count,Data,xd,yd,vr)
		...
		protected function dropItem(X:int,Y:int,breaker:Player=null):void
		{
			...
			if(blockDropItems==null)
			{
				...
				{
					spawnedItem=summonItem(X,Y,blockID,1,blockData,0);
		...
		//================Tile Functions================//
		//==============================================//
		protected function setNewTile(X:int,Y:int,Id:String=TileID.Void,
		...
		public function setTile(X:int,Y:int,Id:String,Data:int=0,
		...
		//================Hook Functions================//
		//==============================================//
		protected function onTileUpdate(X:int,Y:int,Id:String,Data:int,Rot:int,Hard:uint,
										oldId:String,oldData:int,oldRot:int,oldHard:uint):void
		{
			//========Set Variables========//
		...
		protected function onNearbyTileUpdate(X:int,Y:int,Id:String,Data:int,Rot:int,Hard:uint,
											  nearbyX:int,nearbyY:int,nearbyId:String,nearbyData:int,nearbyRot:int,nearbyHard:uint,
											  oldNearbyId:String,oldNearbyData:int,oldNearbyRot:int,oldNearbyHard:uint):void
		{
			//Set Variables
			var tile:Tile=getTileObject(X,Y)
		...
		protected function onPlayerDestroyBlock(P:Player,X:int,Y:int,Pos:uint,Id:String,Data:int,Rot:int,Hard:uint):void
		{
			//trace(arguments)
			//summonItem(X*TILE_SIZE,Y*TILE_SIZE,Id,1,Data,Tag,Rot)
		}
		
		protected function onPlayerDestroyingBlock(P:Player,X:int,Y:int,Pos:uint,Id:String,Data:int,Rot:int,Hard:uint):void
		{
			//trace(arguments)
			//summonItem(X*TILE_SIZE,Y*TILE_SIZE,Id,1,Data,Tag,Rot)
		}

		protected function onPlayerPlaceBlock(P:Player,X:int,Y:int,Pos:uint,Id:String,Data:int,Rot:int,Hard:uint):void
		{
			//trace(arguments)
		}
		
		protected function onPlayerUseItem(P:Player,X:int,Y:int,Pos:uint,Id:String,Data:int,Rot:int,Hard:uint):void
		{
			//trace(arguments)
		}

		protected function onPlayerUseBlock(P:Player,X:int,Y:int,Pos:uint,Id:String,Data:int,Rot:int,Hard:uint):void
		{
			var block:Tile=getTileObject(X,Y)
			switch(Id)
			{
		...
		protected function onPlayerPushBlock(P:Player,X:int,Y:int,Pos:uint,Id:String,Data:int,Rot:int,Hard:uint):void
		{
			//trace(arguments)
		}

		protected function onRandomTick(X:int,Y:int,Id:String,Data:int,Rot:int,Hard:uint):void
		{
		...
		//Spawners
		public function spawnerSpawnBlock(X:int,Y:int,Id:String,Count:uint=0):void
		{
