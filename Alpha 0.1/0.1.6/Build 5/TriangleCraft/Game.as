package TriangleCraft
{
	...
	public class Game extends Sprite
	{
		...
		public static const VERSION:String="Alpha 0.1.6 build 5";
		...
		protected function hasLink(x:int,y:int,rot:uint=TileRot.RIGHT):Boolean
		{
			...
			var selfCanLink:Boolean=(General.binaryToBooleans(getTileAttributes(x,y).canBeLink,4)[MobileRot.lockToPositive(rot-getTileRot(x,y))]||
									 General.binaryToBooleans(getLinksAt(x,y),4)[rot])
			var otherCanLink:Boolean=(General.binaryToBooleans(getTileAttributes(vx,vy).canBeLink,4)[MobileRot.lockToPositive(rot-MobileRot.toOpposite(getTileRot(vx,vy)))]||
