package TriangleCraft.Common
{
	public class Color
	{
		...
		//======RGB======//
		private static function snapRGB(value:Number):Number
		{
			if(isNaN(value))
			{
				return 0
		...
		private static function snapRGBtoUint(value:Number):uint
		{
			if(isNaN(value))
			{
				return 0
		...
		//======HSV======//
		private static function snapH(value:Number):Number
		{
			if(isNaN(value))
			{
				return NaN
		...
		private static function snapS(value:Number):Number
		{
			if(isNaN(value))
			{
				return 0
		...
		private static function snapV(value:Number):Number
		{
			return snapS(value)
		}
	}
