package TriangleCraft.Entity.Entities.Mobile
{
	//TriangleCraft
	...
	public class Mobile extends Entity
	{
		...
		{
			//Detect Mobile Id
			if(!Entity.isAllowMobileType(this._entityType))
			{
			...
			moveBy(MobileRot.rotToPos(dir,dis)[0],MobileRot.rotToPos(dir,dis)[1]);
		}
