package TriangleCraft.Tile
{
	...
	public class TileShape extends MovieClip
	{
		...
		private static function classInit():void
		{
			...
			//====Signal Byte Screen====//
			addCurrent(TileID.Signal_Byte_Screen,0)
			addCurrent(TileID.Signal_Byte_Screen,1)
			addCurrent(TileID.Signal_Byte_Screen,2)
			addCurrent(TileID.Signal_Byte_Screen,3)
			addCurrent(TileID.Signal_Byte_Screen,4)
			addCurrent(TileID.Signal_Byte_Screen,5)
			addCurrent(TileID.Signal_Byte_Screen,6)
			addCurrent(TileID.Signal_Byte_Screen,7)
			addCurrent(TileID.Signal_Byte_Screen,8)
			addCurrent(TileID.Signal_Byte_Screen,9)
			addCurrent(TileID.Signal_Byte_Screen,10)
			addCurrent(TileID.Signal_Byte_Screen,11)
			addCurrent(TileID.Signal_Byte_Screen,12)
			addCurrent(TileID.Signal_Byte_Screen,13)
			addCurrent(TileID.Signal_Byte_Screen,14)
			addCurrent(TileID.Signal_Byte_Screen,15+0)
			addCurrent(TileID.Signal_Byte_Screen,15+1)
			addCurrent(TileID.Signal_Byte_Screen,15+2)
			addCurrent(TileID.Signal_Byte_Screen,15+3)
			addCurrent(TileID.Signal_Byte_Screen,15+4)
			addCurrent(TileID.Signal_Byte_Screen,15+5)
			addCurrent(TileID.Signal_Byte_Screen,15+6)
			addCurrent(TileID.Signal_Byte_Screen,15+7)
			addCurrent(TileID.Signal_Byte_Screen,15+8)
			addCurrent(TileID.Signal_Byte_Screen,15+9)
			addCurrent(TileID.Signal_Byte_Screen,15+10)
			addCurrent(TileID.Signal_Byte_Screen,15+11)
			addCurrent(TileID.Signal_Byte_Screen,15+12)
			addCurrent(TileID.Signal_Byte_Screen,15+13)
			addCurrent(TileID.Signal_Byte_Screen,15+14)
			//====Signal Machines II====//
			...
			addCurrent(TileID.Signal_Byte_CD_Pointer,0)
			addCurrent(TileID.Signal_Byte_CD_Pointer,1)
			addCurrent(TileID.Signal_Byte_CD_Pointer,2)
			addCurrent(TileID.Signal_Byte_CD_Pointer,3)
			addCurrent(TileID.Signal_Byte_CD_Pointer,4)
			addCurrent(TileID.Signal_Byte_CD_Pointer,5)
			addCurrent(TileID.Signal_Byte_CD_Pointer,6)
			addCurrent(TileID.Signal_Byte_CD_Pointer,7)
			//====Signal Byte Getter====//
			...
			addCurrent(TileID.Signal_Byte_Operator_NOT,0)
			addCurrent(TileID.Signal_Byte_Operator_NOT,1)
