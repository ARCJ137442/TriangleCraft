package TriangleCraft
{
	...
	public class Game extends Sprite
	{
		...
		public static const Version:String="Alpha 0.1.3 build 1";
		...
		//-=-=-=-=-=Structure Functions=-=-=-=-=-//
		private function detectStructure(x:int,y:int):IStructure
		{
		...
		private function generateStructures(strs:Vector.<IStructure>):void
		{
