package TriangleCraft
{
	...
	public class GameVariables
	{
		//========Static Variables========//
		//----WorldSpawn----//
		public static const WorldSpawnModes:Vector.<String>=new <String>["Infinity", "Random", "Mini", "Small", "Medium", "Large", "Giant", "Long", "Deep", "Super Giant"]
		...
		public static function get RandomVariables():GameVariables
		{
			...
			variables.WorldSpawnMode=String(GameVariables.WorldSpawnModes[1 + General.random(GameVariables.WorldSpawnModes.length - 2)])//No Spawn Super Giant
			variables.VirusMode=String(GameVariables.VirusModes[General.random(GameVariables.VirusModes.length)])
		...
		public static function get RandomSpawnConditions():uint
		{
			...
			return General.random(Math.pow(2, GameVariables.MaxConditionCount));
		}
