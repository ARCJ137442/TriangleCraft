package TriangleCraft
{
	...
	public class Game extends Sprite
	{
		...
		public static const VERSION:String="Alpha 0.1.5 build 3";
		...
		protected function dropItem(X:int,Y:int):void
		{
			//Detect
		...
		{
			if(Count<=0||Id!=TileID.Block_Spawner&&Id!=TileID.Walls_Spawner)
