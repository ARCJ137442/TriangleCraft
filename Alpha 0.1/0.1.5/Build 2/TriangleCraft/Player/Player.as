package TriangleCraft.Player
{
	...
	public class Player extends Mobile implements IhasSelectableInventory
	{
		...
		protected var SelectItemRevealed:TileDisplayObj=new TileDisplayObj(TileDisplayFrom.IN_ENTITY,xSize,0);
		...
		{
			if(this.SelectItemRevealed.visible&&this.isSelectItem)
			{
