package TriangleCraft
{
	...
	import TriangleCraft.Entity.Entities.EntityItem;
	import TriangleCraft.Entity.Entities.Mobile.Mobile;
	...
	public class Game extends Sprite
	{
		...
		public static const VERSION:String="Alpha 0.1.8 build 1";
		public static const SAVE_OBJECT_NAME:String="TriangleCraftSave"
		public static const SAVE_GAME_NAME:String="TriangleCraftGame"
		...
		public static const FPSDir:uint=100
		...
		public var blockContolerMaxContolDistance:uint=16
		...
		public static function get SAVED_OBJECT():SharedObject
		{
			return SharedObject.getLocal(SAVE_OBJECT_NAME);
		}

		public static function get SAVED_GAME():Game
		{
			return (Game.SAVED_OBJECT.data[SAVE_GAME_NAME] as Game);
		}
										...
										elementText:String="Load Tiles: "):void
		{
			...
			//Dispatch Event
			dispatchEvent(new GameEvent(GameEvent.START_LOADING))
		}
		...
		protected function initDefaultRecipes():void
		{
			...
			//Color Adder
			addCraftRecipe("vbv","bab","vbv",["a",TileID.Color_Mixer,0,0,
											  "b",TileID.Colored_Block,0x000000,0],
						   "vvv","vav","vvv",["a",TileID.Color_Adder,0,0])
			//Block Crafter
			...
			addCraftRecipe("wbw","bsb","wbw",["w",TileID.Basic_Wall,0,0,
						   ...
						   true,true,false,true)
			//Signal Clock
			addCraftRecipe("wbw","dsd","wbw",["w",TileID.Basic_Wall,0,0,
											  "d",TileID.Signal_Delayer,0,0,
											  "b",TileID.Signal_Wire,0,0,
											  "s",TileID.Signal_Patcher,0,0],
						   "vbv","bsb","vbv",["s",TileID.Signal_Clock,0,0,
											  "b",TileID.Colored_Block,0x000000,0],
						   true,true,false,true)
			...
			addCraftRecipe("wbw","bab","wbw",["w",TileID.Basic_Wall,0,0,
						   ...
						   true,true,false,true)
			//Signal Byte Screen
			addCraftRecipe("www","wbw","www",["w",TileID.Basic_Wall,0,0,
											  "b",TileID.Colored_Block,0,0],
						   "sss","sss","sss",["s",TileID.Signal_Byte_Screen,0,0],
						   true,true,false,true)
			//Signal Byte Storage
			addCraftRecipe("wbw","bab","wbw",["w",TileID.Basic_Wall,0,0,
											  "b",TileID.Signal_Wire,0,0,
						   ...
						   true,true,false,true)
			//Signal Byte Trigger
			addCraftRecipe("vbv","bab","vbv",["b",TileID.Signal_Byte_Storage,0,0,
											  "a",TileID.Block_Update_Detector,0x000000,0],
						   "svs","bgb","svs",["s",TileID.Signal_Byte_Trigger,0,0,
											  "b",TileID.Colored_Block,0x000000,0,
											  "g",TileID.Colored_Block,0x888888,0],
						   true,true,true,true)
			//Signal Byte Pointer
			...
			addCraftRecipe("vwv","paw","vwv",["w",TileID.Signal_Wire,0,0,
						   ...
						   "vbv","sss","vbv",["s",TileID.Signal_Byte_Getter,0,0,
											  "b",TileID.Colored_Block,0x000000,0],
						   true,true,false,false)
			//Signal Byte Setter
			addCraftRecipe("vwv","wap","vwv",["w",TileID.Signal_Wire,0,0,
						   ...
						   "vbv","sss","vbv",["s",TileID.Signal_Byte_Setter,0,0,
											  "b",TileID.Colored_Block,0x000000,0],
						   true,true,false,false)
			//Signal Byte Copyer
			addCraftRecipe("vwv","paq","vwv",["w",TileID.Signal_Wire,0,0,
						   ...
						   "vbv","sss","vbv",["s",TileID.Signal_Byte_Setter,0,0,
											  "b",TileID.Colored_Block,0x000000,0],
						   true,true,false,false)
			//Signal Byte Operator NOT
			addCraftRecipe("vvv","waw","vvv",["w",TileID.Signal_Byte_Pointer,0,0,
											  "a",TileID.Signal_Byte_Copyer,0,0],
						   "vvv","vsv","vvv",["s",TileID.Signal_Byte_Operator_NOT,0,0],
						   true,true,false,true)
			...
			addCraftRecipe("vbv","waq","vdv",["w",TileID.Signal_Wire,0,0,
											  ...
											  "a",TileID.Ruby_Wall,0,0,
											  "q",TileID.Signal_Patcher,0,0],
						   "vbv","sbs","vbv",["s",TileID.Signal_Byte_Operator_OR,0,0,
											  "b",TileID.Colored_Block,0x000000,0],
						   true,true,false,false)
			...
			addCraftRecipe("vbv","waq","vdv",["w",TileID.Signal_Wire,0,0,
											  "b",TileID.Signal_Diode,0,0,
											  "d",TileID.Signal_Diode,0,0,
											  "a",TileID.Emerald_Wall,0,0,
											  "q",TileID.Signal_Patcher,0,0],
						   "vbv","sbs","vbv",["s",TileID.Signal_Byte_Operator_AND,0,0,
											  "b",TileID.Colored_Block,0x000000,0],
						   true,true,false,false)
			//Signal Byte Operator XOR
			addCraftRecipe("vbv","waq","vdv",["w",TileID.Signal_Wire,0,0,
											  "b",TileID.Signal_Diode,0,0,
											  "d",TileID.Signal_Diode,0,0,
											  "a",TileID.Sapphire_Wall,0,0,
											  "q",TileID.Signal_Patcher,0,0],
						   "vbv","sbs","vbv",["s",TileID.Signal_Byte_Operator_XOR,0,0,
											  "b",TileID.Colored_Block,0x000000,0],
						   true,true,false,false)
			//Block Destroyer
			...
			addCraftRecipe("wbd","bad","wbd",["w",TileID.Basic_Wall,0,0,
											  "b",TileID.Signal_Wire,0,0,
											  "a",TileID.Arrow_Block,0,0,
											  "d",TileID.Colored_Block,0x00ffff,0],
						   "vbv","vsv","vbv",["s",TileID.Block_Lasher,0,0,
											  "b",TileID.Colored_Block,0x000000,0],
						   true,true,false)
			//Block Thrower
			addCraftRecipe("wbd","bad","wbd",["w",TileID.Basic_Wall,0,0,
											  "b",TileID.Signal_Wire,0,0,
											  "a",TileID.Arrow_Block,0,0,
											  "d",TileID.Colored_Block,0xff00ff,0],
						   "vbv","vsv","vbv",["s",TileID.Block_Thrower,0,0,
											  "b",TileID.Colored_Block,0x000000,0],
						   true,true,false)
			//Block Transporter
			addCraftRecipe("wbd","bad","wbd",["w",TileID.Basic_Wall,0,0,
											  "b",TileID.Signal_Wire,0,0,
											  "a",TileID.Arrow_Block,0,0,
											  "d",TileID.Colored_Block,0xffff00,0],
						   "vbv","vsv","vbv",["s",TileID.Block_Transporter,0,0,
											  "b",TileID.Colored_Block,0x000000,0],
						   true,true,false)
		}
		...
		protected function ResetWorld():void
		{
			...
			//Dispatch Event
			dispatchEvent(new GameEvent(GameEvent.START_RESET))
		}
		...
		protected function onWorldResetComplete(E:TimerEvent=null):void
		{
			...
			this.loadingScreen.deShow()
			//Dispatch Event
			dispatchEvent(new GameEvent(GameEvent.RESET_COMPLETE))
		}
		...
		public function spawnPlayer(ID:uint,X:int=0,Y:int=0,color:Number=NaN):Player
		{
			...
			//========Dispatch Event========//
			dispatchEvent(new GameEvent(GameEvent.PLAYER_ADDED))
			return player;
		}
		...
		//----====Main Functions====----//
		protected function borderTest(player:Player,rot:uint=4):void
		{
			var rX:Number=player.getX()+this.displayX;
			var rY:Number=player.getY()+this.displayY;
			var moveRot:int=(rot>3?player.rot:rot)
			var oppositeRot:int=MobileRot.toOpposite(moveRot)
			if(tcMath.isBetween(rX,TileDisplayOffsetX,borderWidth+TileDisplayOffsetX)&&moveRot==MobileRot.ROT_LEFT||
			   tcMath.isBetween(rX,TileDisplayWidth-borderWidth+TileDisplayOffsetX,TileDisplayWidth+TileDisplayOffsetX)&&moveRot==MobileRot.ROT_RIGHT||
			   tcMath.isBetween(rY,TileDisplayOffsetY,borderHeight+TileDisplayOffsetY)&&moveRot==MobileRot.ROT_UP||
			   tcMath.isBetween(rY,TileDisplayHeight-borderHeight+TileDisplayOffsetY,TileDisplayHeight+TileDisplayOffsetY)&&moveRot==MobileRot.ROT_DOWN)
			{
				var xd:int=MobileRot.rotToPos(oppositeRot,1)[0]
				var yd:int=MobileRot.rotToPos(oppositeRot,1)[1]
		...
		protected function keyDown(E:KeyboardEvent):void
		{
			...
			//Reset World To Debug-Test Mode:Ctrl+Shift+T
			...
			//Reset World To Signal-Test Mode:Ctrl+Shift+T
			...
			//Save Game(This) To SharedObject
			if(ctrl&&shift&&Code==KeyCode.V)
			{
				var so:SharedObject;
				try
				{
					so=SAVED_OBJECT;
					so.data[SAVE_GAME_NAME]=this;
		...
		protected function EnterWorldTick(E:TimerEvent):void
		{
			...
			//Dispatch Event
			dispatchEvent(new GameEvent(GameEvent.GAME_TICK))
			//Reset Timer
		...
		public function playerMove(player:Player,rot:uint,distance:uint):void
		{
			...
			if(!Key.shiftKey) player.rot=rot;
			//if(Key.shiftKey) return
			var pX:int=player.getX();
			var pY:int=player.getY();
			var mX:int=player.getX()+MobileRot.rotToPos(rot,distance/TILE_SIZE)[0];
			var mY:int=player.getY()+MobileRot.rotToPos(rot,distance/TILE_SIZE)[1];
			if(testMove(player,mX,mY,pX,pY))
			{
				//Border Test
				borderTest(player,rot);
				//Real Move
			...
			{
				//Test Push
				var moveX:int=mX+MobileRot.rotToPos(rot)[0];
				var moveY:int=mY+MobileRot.rotToPos(rot)[1];
			...
			//Use
			if(player.rot==rot&&isTile(mX,mY)&&getTileAttributes(mX,mY).canUse&&player.ability.canUseBlock)
			{
				onPlayerUseBlock(player,mX,mY,player.rot,getTileID(mX,mY),getTileData(mX,mY),getTileRot(mX,mY),getTileHard(mX,mY));
			}
		}
		...
		public function playerUse(player:Player,Distance:uint):void
		{
			...
			var frontX:int=player.getX()+MobileRot.rotToPos(Rot,Distance/TILE_SIZE)[0];
			var frontY:int=player.getY()+MobileRot.rotToPos(Rot,Distance/TILE_SIZE)[1];
			//Detect IsTile
			...
			if(player.isSelectItem&&player.ability.canPlace&&place)
			{
				...
				var placeRot:int=placeAttributes.canRotate?MobileRot.mobileRotToTileRot(player.rot):0
		...
		public function regEntity(Ent:Entity):void
		{
			...
			//========Dispatch Event========//
			dispatchEvent(new GameEvent(GameEvent.ENTITY_ADDED))
		}
		...
		{
			//========Dispatch Event========//
			dispatchEvent(new GameEvent(GameEvent.ENTITY_REMOVE))
			//
			entity.deleteSelf()
		...
		public function summonItem(X:Number,Y:Number,
								  ...
								  xd:Number=NaN,yd:Number=NaN,vr:Number=NaN):TriangleCraft.Entity.Entities.EntityItem
		{
		...
		public function updateAllCraftRecipePreview(sourceX:int,sourceY:int):void
		{
				...
				if(ent!=null)
				{
					switch(ent.entityType)
					{
						case EntityType.CraftRecipePreview:
							this.detectCraftRecipePreview(ent as CraftRecipePreview,sourceX,sourceY)
							break
					}
				}
				else
		...
		public function detectItem(item:TriangleCraft.Entity.Entities.EntityItem):void
		{
			//Set Variables
		...
		public function detectCraftRecipePreview(crp:CraftRecipePreview,sourceX:int,sourceY:int):void
		{
			//Detect
			if(crp==null||!crp.isActive) return
			var crpX:int=crp.getX(),crpY:int=crp.getY()//+(crp.getX()>0?1:0)+(crp.getY()>0?1:0)
			if(!isTile(crpX,crpY)||getTileID(crpX,crpY)!=TileID.Block_Crafter)
			{
				removeEntity(crp)
				return
			}
			...
			//Detect II
			if(tcMath.getDistance(crpX+offsetX,crpY+offsetY,sourceX,sourceY)>CraftRecipePreview.UPDATE_MAX_DISTANCE) return
			//Init Variables II
			...
			for(var Yp:int=-1;Yp<=1;Yp++)
			{
				...
				{
					//Set XY
					inputX=crpX+offsetX+Xp
					inputY=crpY+offsetY+Yp
					//Detect
		...
		protected function dropItem(X:int,Y:int,breaker:Player=null):void
		{
			...
			var spawnedItem:TriangleCraft.Entity.Entities.EntityItem
		...
		public function setTileAsItem(X:int,Y:int,item:*):Boolean
		{
			...
			else if(item is TriangleCraft.Entity.Entities.EntityItem)
			{
				id=(item as TriangleCraft.Entity.Entities.EntityItem).id
				data=(item as TriangleCraft.Entity.Entities.EntityItem).data
			}
										...
										oldId:TileID,oldData:int,oldRot:int,oldHard:uint):void
		{
			...
			//Entity
			updateAllCraftRecipePreview(x,y)
			//========Add Count========//
			if(this.isActive)
			{
				//Add
			...
			//========Dispatch Event========//
			dispatchEvent(new GameEvent(GameEvent.TILE_UPDATE))
		}
											  ...
											  oldNearbyId:TileID,oldNearbyData:int,oldNearbyRot:int,oldNearbyHard:uint):void
		{
			...
			var hasLinkAbsUp:Boolean,hasLinkAbsDown:Boolean
			var hasLinkAbsLeft:Boolean,hasLinkAbsRight:Boolean
			switch(id)
			{
				//Signal_Wire:Link Blocks
				case TileID.Signal_Wire:
					hasLinkAbsUp=hasLink(x,y,TileRot.UP)
					hasLinkAbsDown=hasLink(x,y,TileRot.DOWN)
					hasLinkAbsLeft=hasLink(x,y,TileRot.LEFT)
					hasLinkAbsRight=hasLink(x,y,TileRot.RIGHT)
					signalWireTrunLink(x,y,hasLinkAbsUp,hasLinkAbsDown,hasLinkAbsLeft,hasLinkAbsRight)
					break;
				//Signal_Byte_Screen:Connect Blocks
				case TileID.Signal_Byte_Screen:
					signalScreenUpdate(x,y)
					break;
				...
				case TileID.Signal_Random_Filter:
					...
					tile.data=shouldData
					break;
				//Signal Byte Getter|Setter|Copyer|Operator:Link Blocks
			...
			//========Dispatch Event========//
			dispatchEvent(new GameEvent(GameEvent.NEARBY_TILE_UPDATE))
		}
		
		protected function onPlayerDestroyBlock(player:Player,x:int,y:int,pos:uint,id:TileID,data:int,rot:int,hard:uint):void
		{
			//trace(arguments)
			//summonItem(X*TILE_SIZE,Y*TILE_SIZE,Id,1,Data,Tag,Rot)
			//========Dispatch Event========//
			dispatchEvent(new GameEvent(GameEvent.PLAYER_DESTROY_BLOCK))
		}
		
		protected function onPlayerDestroyingBlock(player:Player,x:int,y:int,pos:uint,id:TileID,data:int,rot:int,hard:uint):void
		{
			//trace(arguments)
			//========Dispatch Event========//
			dispatchEvent(new GameEvent(GameEvent.PLAYER_DESTROYING_BLOCK))
		}

		protected function onPlayerPushBlock(player:Player,x:int,y:int,pos:uint,id:TileID,data:int,rot:int,hard:uint):void
		{
			//trace(arguments)
			//========Dispatch Event========//
			dispatchEvent(new GameEvent(GameEvent.PLAYER_PUSH_BLOCK))
		}

		protected function onPlayerPlaceBlock(player:Player,x:int,y:int,pos:uint,id:TileID,data:int,rot:int,hard:uint):void
		{
			//trace(arguments)
			//========Dispatch Event========//
			dispatchEvent(new GameEvent(GameEvent.PLAYER_PLACE_BLOCK))
		}
		
		protected function onPlayerUseItem(player:Player,x:int,y:int,pos:uint,id:TileID,data:int,rot:int,hard:uint):void
		{
			//trace(arguments)
			//========Dispatch Event========//
			dispatchEvent(new GameEvent(GameEvent.PLAYER_USE_ITEM))
		}

		protected function onPlayerUseBlock(player:Player,x:int,y:int,pos:uint,id:TileID,data:int,rot:int,hard:uint):void
		{
			var block:Tile=getTileObject(x,y)
			switch(id)
			{
				...
				case TileID.Color_Mixer:
					...
					break;
				//Color Adder:Add Color
				case TileID.Color_Adder:
					colorAdderAddColor(x,y)
					break;
				...
				case TileID.Barrier:
					barrierExtendBorder(x,y,player)
					break
					...
					if(player.hasInventory)
					{
						switch(pos)
						{
							...
							case MobileRot.ROT_UP:
								inventoryBlockTransPortItem(x,y,player,"up")
								break
							//Download
							case MobileRot.ROT_DOWN:
								inventoryBlockTransPortItem(x,y,player,"down")
							break
				...
				case TileID.Signal_Patcher:
					patchSignal(x,y)
					break;
				//Signal Wire Block:Trun Wire
				case TileID.Signal_Wire_Block:
					signalWireBlockTrunWire(x,y,MobileRot.toOpposite(pos))
					break;
				//Signal Clock:On/Off Clock
				case TileID.Signal_Clock:
					signalClockTrunMode(x,y)
					break;
				...
				case TileID.Block_Destroyer:
					blockDestroyerDestroyBlock(x,y,player.getX(),player.getY())
					break;
				...
				case TileID.Block_Swaper:
					...
					break;
				//Block Lasher:Lash Block
				case TileID.Block_Lasher:
					blockLasherLashBlock(x,y)
					break;
				//Block Thrower:Throw Block
				case TileID.Block_Thrower:
					blockThrowerThrowBlock(x,y)
					break;
				//Block Transporter:Transport Block
				case TileID.Block_Transporter:
					blockTransporterTransportBlock(x,y)
					break;
				//Signal Byte Storage:Trun Byte
				case TileID.Signal_Byte_Storage:
					signalByteStorageTrunByte(x,y)
					break
				//Signal Byte Trigger:Trun Byte
				case TileID.Signal_Byte_Trigger:
					signalByteTriggerTrunByte(x,y)
					break
				//Signal Byte Screen:Trun Byte
				case TileID.Signal_Byte_Screen:
					signalByteScreenTrunLight(x,y)
					break
				...
				case TileID.Signal_Byte_CD_Pointer:
					signalCDPointerTrunDistance(x,y)
					break
			}
			//========Dispatch Event========//
			dispatchEvent(new GameEvent(GameEvent.PLAYER_USE_BLOCK))
		}
		...
		protected function onRandomTick(X:int,Y:int,Id:TileID,Data:int,Rot:int,Hard:uint):void
		{
			...
			//========Dispatch Event========//
			dispatchEvent(new GameEvent(GameEvent.RANDOM_TICK))
		}
		...
		protected function onTickTileRun(information:TickRunTileInformations):void
		{
			...
			switch(block.id)
			{
				...
				case TileID.Signal_Random_Filter:
					...
					break
				case TileID.Signal_Clock:
						if(block.data>0) patchSignal(x,y)
						else remTickRunTile(x,y)
					break;
			}
		}
		
		protected function onSignalError(x:int,y:int,error:Error=null,sourceMethod:String=null):void
		{
			trace(sourceMethod+":Error! x="+x+",y="+y+",id="+getTileID(x,y)+"\n"+error.getStackTrace())
			dropItem(x,y)
			setVoid(x,y)
			//setTile(x,y,TileID.Signal_Error_Mark,0,0)
		}
		...
		{
			var MixBlocks:Vector.<Tile>=getCanMixBlocks(x,y,TileID.Color_Mixer);
			...
			for each(var t:Tile in MixBlocks)
			{
				...
				var tY=t.tileY;
				var tI=t.id;
				setTile(tX,tY,tI,AverageColor);
			}
		}
		
		//Color Adder
		protected function colorAdderAddColor(x:int,y:int):void
		{
			var MixBlocks:Vector.<Tile>=getCanMixBlocks(x,y,TileID.Color_Adder);
			var BlockColors:Vector.<uint>=new Vector.<uint>;
			var finalColor:uint
			for each(var tile:Tile in MixBlocks)
			{
			...
			for each(var color:uint in BlockColors)
			{
				finalColor=Math.min(finalColor+color,0xffffff)
			}
			for each(var t:Tile in MixBlocks)
			{
				var tX=t.tileX;
				var tY=t.tileY;
				var tI=t.id;
				setTile(tX,tY,tI,finalColor);
			}
		}
		
		protected function getCanMixBlocks(x,y,id:TileID,pastVec:Vector.<String>=null):Vector.<Tile>
		{
			...
			if(nowBlock.id==id)
			{
				returnVec=returnVec.concat(getCanMixBlocks(x+1,y,id,memoryVec));
				returnVec=returnVec.concat(getCanMixBlocks(x-1,y,id,memoryVec));
				returnVec=returnVec.concat(getCanMixBlocks(x,y+1,id,memoryVec));
				returnVec=returnVec.concat(getCanMixBlocks(x,y-1,id,memoryVec));
			}
			return returnVec;
		}
					...
					if((getTileAttributes(cx,cy)==null||getTileAttributes(cx,cy).canPlaceBy)||TileSystem.isVirus(blockID))
					{
								...
								randomBoolean2(1/4))
						{
							if(sec==0||randomBoolean2(1/(sec+1)/3))
							{
								sec++
								spawnRandomColoredBlock(cx,cy)
								blockID=randomBoolean(1,0xf)?TileIDSpace.SPECIAL_WALL.randomID:TileID.Basic_Wall
		...
		protected function getLinksAt(x:int,y:int):uint
		{
			var hasLinkAbsUp:Boolean=false;
			var hasLinkAbsDown:Boolean=false;
			var hasLinkAbsLeft:Boolean=false;
			var hasLinkAbsRight:Boolean=false;
			var data:int=getTileData(x,y);
			var rot:uint=getTileRot(x,y);
			switch(data)
			{
				case 1:
					if(rot==0) hasLinkAbsRight=true;
					if(rot==1) hasLinkAbsDown=true;
					if(rot==2) hasLinkAbsLeft=true;
					if(rot==3) hasLinkAbsUp=true;
				break;
				case 2:
					if(rot==0||rot==1) hasLinkAbsRight=true;
					if(rot==1||rot==2) hasLinkAbsDown=true;
					if(rot==2||rot==3) hasLinkAbsLeft=true;
					if(rot==3||rot==0) hasLinkAbsUp=true;
				break;
				case 3:
					if(rot==0||rot==2) hasLinkAbsRight=true;
					if(rot==1||rot==3) hasLinkAbsDown=true;
					if(rot==2||rot==0) hasLinkAbsLeft=true;
					if(rot==3||rot==1) hasLinkAbsUp=true;
				break;
				case 4:
					if(rot!=2) hasLinkAbsRight=true;
					if(rot!=3) hasLinkAbsDown=true;
					if(rot!=0) hasLinkAbsLeft=true;
					if(rot!=1) hasLinkAbsUp=true;
				break;
				case 5:
					return 15;
				case 0:
			...
			return General.booleansToBinary(hasLinkAbsRight,hasLinkAbsDown,hasLinkAbsLeft,hasLinkAbsUp);
		}
		
		protected function signalWireTrunLink(x:int,y:int,
											  linkAbsUp:Boolean,linkAbsDown:Boolean,
											  linkAbsLeft:Boolean,linkAbsRight:Boolean):void
		{
			var tile:Tile=getTileObject(x,y)
			var linkCount=uint(linkAbsUp)+uint(linkAbsDown)+uint(linkAbsLeft)+uint(linkAbsRight)
			var shouldData:uint
			...
			switch(linkCount)
			{
				...
				case 1:
					shouldData=1
					if(linkAbsUp) shouldRot=TileRot.UP
					else if(linkAbsDown) shouldRot=TileRot.DOWN
					else if(linkAbsLeft) shouldRot=TileRot.LEFT
					else shouldRot=TileRot.RIGHT
					break
				case 2:
					if(linkAbsUp!=linkAbsDown)
					{
						shouldData=2
						if(linkAbsUp) shouldRot=linkAbsRight?TileRot.RIGHT:TileRot.UP
						else if(linkAbsDown) shouldRot=linkAbsRight?TileRot.DOWN:TileRot.LEFT
					}
					else
					{
						shouldData=3
						if(linkAbsUp&&linkAbsDown) shouldRot=TileRot.DOWN
						else if(linkAbsLeft) shouldRot=TileRot.RIGHT
					}
					break
				case 3:
					shouldData=4
					if(!linkAbsUp) shouldRot=TileRot.DOWN
					else if(!linkAbsDown) shouldRot=TileRot.UP
					else if(!linkAbsLeft) shouldRot=TileRot.RIGHT
		...
		protected function signalScreenUpdate(x:int,y:int):void
		{
			//Center
			signalScreenTrunLink(x,y);
			//Side
			signalScreenTrunLink(x+1,y);
			signalScreenTrunLink(x,y+1);
			signalScreenTrunLink(x-1,y);
			signalScreenTrunLink(x,y-1);
			//Corner
			signalScreenTrunLink(x+1,y+1);
			signalScreenTrunLink(x-1,y+1);
			signalScreenTrunLink(x-1,y-1);
			signalScreenTrunLink(x+1,y-1);
		}
		
		protected function signalScreenTrunLink(x:int,y:int):void
		{
			if(getTileID(x,y)!=TileID.Signal_Byte_Screen) return;
			var tile:Tile=getTileObject(x,y);
			var linkAbsUp:Boolean=hasScreenLink(x,y,TileRot.UP);
			var linkAbsDown:Boolean=hasScreenLink(x,y,TileRot.DOWN);
			var linkAbsLeft:Boolean=hasScreenLink(x,y,TileRot.LEFT);
			var linkAbsRight:Boolean=hasScreenLink(x,y,TileRot.RIGHT);
			//var linkCount=uint(linkAbsUp)+uint(linkAbsDown)+uint(linkAbsLeft)+uint(linkAbsRight);
			var dotUR:Boolean=linkAbsUp&&linkAbsRight&&getTileID(x+1,y-1)!=TileID.Signal_Byte_Screen;
			var dotUL:Boolean=linkAbsUp&&linkAbsLeft&&getTileID(x-1,y-1)!=TileID.Signal_Byte_Screen;
			var dotDR:Boolean=linkAbsDown&&linkAbsRight&&getTileID(x+1,y+1)!=TileID.Signal_Byte_Screen;
			var dotDL:Boolean=linkAbsDown&&linkAbsLeft&&getTileID(x-1,y+1)!=TileID.Signal_Byte_Screen;
			//var linkCornerCount:uint=uint(linkCornerUR)+uint(linkCornerUL)+uint(linkCornerDR)+uint(linkCornerDL);
			setScreen(x,y,!linkAbsUp,!linkAbsDown,!linkAbsLeft,!linkAbsRight,
					  dotUL,dotUR,dotDL,dotDR,
					  tile.data>14)
		}
		
		protected function setScreen(x:int,y:int,
									 upLine:Boolean,downLine:Boolean,leftLine:Boolean,rightLine:Boolean,
									 ULDot:Boolean,URDot:Boolean,DLDot:Boolean,DRDot:Boolean,
									 isLighted:Boolean):void
		{
			//Test
			if(!isTile(x,y)) return;
			//Abs Location
			ULDot=ULDot&&!upLine&&!leftLine;
			URDot=URDot&&!upLine&&!rightLine;
			DLDot=DLDot&&!downLine&&!leftLine;
			DRDot=DRDot&&!downLine&&!rightLine;
			var lineCount=uint(upLine)+uint(downLine)+uint(leftLine)+uint(rightLine);
			var dotCount:uint=uint(ULDot)+uint(URDot)+uint(DLDot)+uint(DRDot);
			var tile:Tile=getTileObject(x,y);
			var shouldData:uint=0;
			var shouldRot:uint=TileRot.RIGHT;
			var tempDot1:Boolean,tempDot2:Boolean;
			//Operation
			switch(lineCount)
			{
				//Zero Line
				case 0:
					...
					{
						shouldData++;
						if(URDot) shouldRot=TileRot.RIGHT;
						else if(ULDot) shouldRot=TileRot.UP;
						else if(DRDot) shouldRot=TileRot.DOWN;
						else if(DLDot) shouldRot=TileRot.LEFT;
					}
					//Two Point
					else if(dotCount==2)
					{
						...
						{
							shouldData+=2;
							if(ULDot) shouldRot=TileRot.DOWN;
							else shouldRot=TileRot.RIGHT;
						}
						//Lined
						else
						{
							shouldData+=3;
							if(DRDot&&URDot) shouldRot=TileRot.RIGHT;
							else if(DRDot&&DLDot) shouldRot=TileRot.DOWN;
							else if(ULDot&&DLDot) shouldRot=TileRot.LEFT;
							else if(ULDot&&URDot) shouldRot=TileRot.UP;
						}
					}
					//Three Point
					else if(dotCount==3)
				...
				case 1:
					...
					if(rightLine)
					{
						shouldRot=TileRot.LEFT;
						tempDot1=DLDot;
						tempDot2=ULDot;
					}
					else if(upLine)
					{
						shouldRot=TileRot.DOWN;
						tempDot1=DRDot;
						tempDot2=DLDot;
					}
					else if(downLine)
					{
						shouldRot=TileRot.UP;
						tempDot1=ULDot;
						tempDot2=URDot;
					}
					else if(leftLine)
					{
						shouldRot=TileRot.RIGHT;
						tempDot1=URDot;
						tempDot2=DRDot;
					}
					if(tempDot1&&tempDot2) break;
					else if(!tempDot1&&tempDot2) shouldData+=1;
					else if(tempDot1&&!tempDot2) shouldData+=2;
					else if(!tempDot1&&!tempDot2) shouldData+=3;
					break;
				//Two Line
				case 2:
					shouldData=2;
					...
					{
						shouldData+=2;
						if(leftLine) shouldRot=TileRot.DOWN;
						else shouldRot=TileRot.RIGHT;
					}
					//Corner
					else
					{
						...
						else if(rightLine&&downLine)
						{
							shouldRot=TileRot.UP;
							tempDot1=ULDot;
						}
						else if(downLine&&leftLine)
						{
							shouldRot=TileRot.RIGHT;
							tempDot1=URDot;
						}
						else if(leftLine&&upLine)
						{
							shouldRot=TileRot.DOWN;
							tempDot1=DRDot;
						}
						if(!tempDot1) shouldData++;
					}
					break;
				//Three Line
				case 3:
					shouldData=1;
					if(!rightLine) shouldRot=TileRot.RIGHT;
					else if(!upLine) shouldRot=TileRot.UP;
					else if(!downLine) shouldRot=TileRot.DOWN;
					else if(!leftLine) shouldRot=TileRot.LEFT;
					break;
				//Four Line
				default:
					shouldData=0;
			...
			if(isLighted) shouldData+=15
			//Set
			tile.data=shouldData;
			tile.rot=shouldRot;
		}
		
		protected function signalWireBlockTrunWire(x:int,y:int,trunsRot:uint):void
		{
			var linkPoses:Vector.<Boolean>=General.binaryToBooleans(getLinksAt(x,y),4)
			//0=Right,1=Down,2=Left,3=Up
			linkPoses[trunsRot]=!linkPoses[trunsRot]
			var oldData:int=getTileData(x,y),oldRot:uint=getTileRot(x,y)
			signalWireTrunLink(x,y,linkPoses[3],linkPoses[1],linkPoses[2],linkPoses[0])
			onTileUpdate(x,y,getTileID(x,y),getTileData(x,y),getTileRot(x,y),getTileHard(x,y),
						 getTileID(x,y),oldData,oldRot,getTileHard(x,y))
		}
		
		protected function signalClockTrunMode(x:int,y:int):void
		{
			if(isVoid(x,y)||getTileID(x,y)!=TileID.Signal_Clock) return
			var nowData:uint=getTileData(x,y)
			var nextData:uint=1^nowData
			if(nextData) regTickRunTile(x,y)
			getTileObject(x,y).data=uint(nextData)
		}
		...
		protected function signalByteScreenTrunLight(x:int,y:int):void
		{
			if(isVoid(x,y)||getTileID(x,y)!=TileID.Signal_Byte_Screen) return
			getTileObject(x,y).data=(getTileData(x,y)+15)%30
		}

		protected function signalCDPointerTrunDistance(x:int,y:int):void
		{
			if(isVoid(x,y)||getTileID(x,y)!=TileID.Signal_Byte_CD_Pointer) return
			getTileObject(x,y).data=(getTileData(x,y)+1)%8
		}
		...
		protected function blockPusherPushBlock(x:int,y:int):void
		{
			...
			//Detect
			for(var i:uint=1;i<=blockContolerMaxContolDistance;i++)
			{
				cx=x+vx*i,cy=y+vy*i
		...
		protected function blockLasherLashBlock(x:int,y:int):void
		{
			//Define
			var rot:int=getTileRot(x,y)
			var vx:int=TileRot.toPosPoint(rot).x
			...
			var my:int=y+vy
			//Detect
			if(!isVoid(mx,my)||!getTileAttributes(mx,my).canPlaceBy) return
			//Move
			var cx:int
			var cy:int
			for(var i:uint=2;i<=blockContolerMaxContolDistance;i++)
			{
				cx=x+vx*i,cy=y+vy*i
				if(!isTile(cx,cy)) continue
				if(!isVoid(cx,cy)&&getTileAttributes(cx,cy).canBeMove)
				{
					cloneTile(cx,cy,mx,my,"move")
					return
				}
			}
		}
		
		protected function blockThrowerThrowBlock(x:int,y:int):void
		{
			//Define
			var rot:int=getTileRot(x,y)
			var vx:int=TileRot.toPosPoint(rot).x
			...
			var my:int=y+vy
			//Detect
			if(isVoid(mx,my)||!getTileAttributes(mx,my).canBeMove) return
			//Move
			var lx:int
			var ly:int
			var cx:int
			...
			{
				lx=x+vx*i,ly=y+vy*i
				cx=x+vx*(i+1),cy=y+vy*(i+1)
				if(!isTile(cx,cy)) continue
				if(!isVoid(cx,cy)&&!getTileAttributes(cx,cy).canPlaceBy)
				{
					break
				}
			}
			if(mx!=lx||my!=ly)
			{
				cloneTile(mx,my,lx,ly,"move")
			}
		}
		
		protected function blockTransporterTransportBlock(x:int,y:int):void
		{
			//Define
			var rot:int=getTileRot(x,y)
			var vx:int=TileRot.toPosPoint(rot).x
			...
			var my:int=y+vy
			//Detect
			if(!getTileAttributes(mx,my).canBeMove) return
			//Move
			var id:TileID=getTileID(x,y)
			var lx:int
			var ly:int
			var cx:int
			var cy:int
			//Find Another Half And Move
			for(var i:uint=1;i<=blockContolerMaxContolDistance;i++)
			{
				lx=x+vx*i,ly=y+vy*i
				cx=x+vx*(i+1),cy=y+vy*(i+1)
				if(getTileID(cx,cy)==id&&MobileRot.toOpposite(rot)==getTileRot(cx,cy))
				{
					if(!getTileAttributes(lx,ly).canBeMove) return
					cloneTile(mx,my,lx,ly,"swap")
				}
			}
		}
		...
		//Signal Byte Trigger
		protected function signalByteTriggerTrunByte(x:int,y:int,mode:int=-1):void
		{
			if(!isTile(x,y)||getTileID(x,y)!=TileID.Signal_Byte_Trigger) return
			var lastMode:uint=getTileData(x,y)
			var nextMode:uint=mode>0?mode:(1-lastMode)
			setTile(x,y,TileID.Signal_Byte_Trigger,nextMode)
			//Patch
			if(lastMode!=nextMode)
			{
				try
				{
					var memoryBlocks:Vector.<Point>=new Vector.<Point>()
					var p0:Point,p:Point
					for(var i:uint=0;i<4;i++)
					{
						p0=MobileRot.toPosPoint(i,1)
						p=new Point(x+p0.x,y+p0.y)
						//Filter
						if(isVoid(p.x,p.y)) continue
						if(TileIDSpace.MECHINES_BYTE.has(getTileID(p.x,p.y)))
						{
							signalByteMechineActive(p,x,y,memoryBlocks,true)
						}
						else
						{
				...
				{
					onSignalError(p.x,p.y,err,"signalByteTriggerTrunByte")
				}
			}
		}
		...
		protected function hasByteSignal(x:int,y:int):Boolean
		{
			...
			var tileID:TileID=getTileID(x,y)
			var tileData:int=getTileData(x,y)
			var tileAttributes:TileAttributes=getTileAttributes(x,y)
			if(tileAttributes.hasByteSignal) return true
			return false
		}
		...
		protected function getByte(x:int,y:int,reverse:Boolean=false):Boolean
		{
			...
			switch(tileID)
			{
				...
				case TileID.Signal_Byte_Pointer:
					...
					break
				case TileID.Signal_Byte_CD_Pointer:
					p=signalByteCDPointerPointTo(x,y)
					if(!isNaN(p.x)&&!isNaN(p.y))
					{
						byte=getByte(p.x,p.y)
					}
		...
		protected function setByte(x:int,y:int,byte:Boolean=false):void
		{
			...
			switch(tileID)
			{
				case TileID.Signal_Byte_Storage:
					...
					return
				case TileID.Signal_Byte_Trigger:
					if((tileData>0)!=byte) signalByteTriggerTrunByte(x,y)
					return
				case TileID.Signal_Lamp:
					if((tileData>0)!=byte) signalLampTrunLight(x,y)
					return
				case TileID.Signal_Clock:
					if((tileData>0)!=byte) signalClockTrunMode(x,y)
					return
				case TileID.Signal_Byte_Screen:
					if((tileData>14)!=byte) signalByteScreenTrunLight(x,y)
					return
				case TileID.Colored_Block:
		...
		protected function signalBytePointerPointTo(x:int,y:int,memory:Vector.<Point>=null):Point
		{
			...
			for(var i:uint=1;i<=maxWirelessSignalTransmissionDistance;i++)
			{
				...
				if(hasByteSignal(cx,cy))
				{
					...
					else if(block.id==TileID.Signal_Byte_CD_Pointer)
					{
						return signalByteCDPointerPointTo(cx,cy,memory)
					}
					else
					{
		...
		protected function signalByteCDPointerPointTo(x:int,y:int,memory:Vector.<Point>=null):Point
		{
			var rot:uint=getTileRot(x,y)
			var vx:int=TileRot.toPos(rot)[0],vy:int=TileRot.toPos(rot)[1]
			var cx:int,cy:int,block:Tile
			memory=(memory==null?new Vector.<Point>:memory),memory.push(new Point(x,y))
			//Get
			cx=x+vx*(getTileData(x,y)+1),cy=y+vy*(getTileData(x,y)+1)
			if(isTile(cx,cy))
			{
				block=getTileObject(cx,cy)
				if(!hasInMemory(memory,cx,cy)&&hasByteSignal(cx,cy))
				{
					if(block.id==TileID.Signal_Byte_Pointer)
					{
						return signalBytePointerPointTo(cx,cy,memory)
					}
					else if(block.id==TileID.Signal_Byte_CD_Pointer)
		...
		protected function signalByteMechineActive(p:Point,x:int,y:int,memoryBlocks:Vector.<Point>,ignoreSource:Boolean=false):void
		{
			try
			{
				//Real Signal
				...
				{
					case TileID.Signal_Byte_Getter:
						if(ignoreSource||!op.equals(vp)&&!op.equals(ovp))
						{
							signalByteGetterGetByte(p.x,p.y,memoryBlocks)
						}
						break
					case TileID.Signal_Byte_Setter:
						if(ignoreSource||!op.equals(ovp))
						{
					...
					case TileID.Signal_Byte_Copyer:
						...
						break
					case TileID.Signal_Byte_Operator_NOT:
						signalByteOperatorNOTReverseByte(p.x,p.y,memoryBlocks)
						break
					case TileID.Signal_Byte_Operator_OR:
			...
			{
				onSignalError(p.x,p.y,err,"signalByteMechineActive")
			}
		}
		...
		protected function signalByteGetterGetByte(x:int,y:int,memory:Vector.<Point>=null):void
		{
			...
			if(!isTile(bX,bY)||!hasByteSignal(bX,bY)) return
		...
		protected function signalByteSetterSetByte(x:int,y:int,memory:Vector.<Point>=null):void
		{
			...
			if(!isTile(fX,fY)||!hasByteSignal(fX,fY)) return
			setByte(fX,fY,getTileData(x,y)<2)
		}
		
		protected function signalByteCopyerCopyByte(x:int,y:int,memory:Vector.<Point>=null):void
		{
			var rot:int=getTileRot(x,y)
			var backX:int=x-TileRot.toPos(rot)[0],backY:int=y-TileRot.toPos(rot)[1]
			var frontX:int=x+TileRot.toPos(rot)[0],frontY:int=y+TileRot.toPos(rot)[1]
			var isReversed:Boolean=getTileData(x,y)>3
			var fromByte:Boolean=getByte(backX,backY)//Not Reverse of Getting
			if(!isTile(frontX,frontY)) return
			if(getTileData(x,y)%4==3)//Only Active On Full Link
			{
				if(hasByteSignal(backX,backY))
				{
					setByte(frontX,frontY,isReversed?!fromByte:fromByte)//Reverse of Setting
				}
			}
		}
		
		protected function signalByteOperatorNOTReverseByte(x:int,y:int,memory:Vector.<Point>=null):void
		{
			var rot:int=getTileRot(x,y)
			var fX:int=x+TileRot.toPos(rot)[0],fY:int=y+TileRot.toPos(rot)[1]
			if(!isTile(fX,fY)||!hasByteSignal(fX,fY)) return
			setByte(fX,fY,!getByte(fX,fY))
		}
		...
		protected function hasLink(x:int,y:int,rot:uint=TileRot.RIGHT):Boolean
		{
			...
			if(!isTile(vx,vy)) return false
			var selfCanLink:Boolean=(General.binaryToBooleans(getTileAttributes(x,y).canBeLink,4)[MobileRot.lockRotToPositive(rot-getTileRot(x,y))]||
									 General.binaryToBooleans(getLinksAt(x,y),4)[rot])
			var otherCanLink:Boolean=(General.binaryToBooleans(getTileAttributes(vx,vy).canBeLink,4)[MobileRot.lockRotToPositive(rot-MobileRot.toOpposite(getTileRot(vx,vy)))]||
									  General.binaryToBooleans(getLinksAt(vx,vy),4)[MobileRot.toOpposite(rot)])
			var returnBoolean:Boolean=selfCanLink&&otherCanLink
		...
		protected function hasByteLink(x:int,y:int,rot:uint=TileRot.RIGHT,isSetter:Boolean=false):Boolean
		{
			...
			var tileAttributes:TileAttributes=getTileAttributes(cx,cy)
			return (!isSetter&&tileAttributes.hasByteGetterLink||
					isSetter&&tileAttributes.hasByteSetterLink)
		}
		
		protected function hasScreenLink(x:int,y:int,rot:uint=TileRot.RIGHT):Boolean
		{
			var vx:int=x+TileRot.toPos(rot)[0],vy:int=y+TileRot.toPos(rot)[1]
			if(!isTile(vx,vy)) return false
			var returnBoolean:Boolean=getTileID(vx,vy)==TileID.Signal_Byte_Screen
			return returnBoolean
		}
			...
			try
			{
				...
				switch(block.id)
				{
					...
					case TileID.Block_Swaper:
						...
						break;
					case TileID.Block_Lasher:
						blockLasherLashBlock(p.x,p.y)
						break;
					case TileID.Block_Thrower:
						blockThrowerThrowBlock(p.x,p.y)
						break;
					case TileID.Block_Transporter:
						blockTransporterTransportBlock(p.x,p.y)
						break;
					case TileID.Signal_Byte_CD_Pointer:
						signalCDPointerTrunDistance(p.x,p.y)
						break
				}
				//Byte Mechine
				if(TileIDSpace.MECHINES_BYTE.has(block.id))
				{
					signalByteMechineActive(p,x,y,memoryBlocks)
				}
				//========Dispatch Event========//
				dispatchEvent(new GameEvent(GameEvent.PATCH_A_SIGNAL))
			}
			catch(err)
			{
				onSignalError(p.x,p.y,err,"patchASignal")
			}
		}
