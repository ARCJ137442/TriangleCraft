package TriangleCraft
{
	...
	public class Game extends Sprite
	{
		...
		public static const Version:String="Alpha 0.1.2 build 4";
		...
		//DebugText
		intc static const MainFormet:TextFormat=new TextFormat("MainFont",16,0x000000,false,false,null,null,null,"left");
		intc static const MainFormet2:TextFormat=new TextFormat("MainFont",16,0x000000,false,false,null,null,null,"right");
		...
		private var gameLoadingTimer:Timer=new Timer(0)
		...
		private function onGameInit(E:Event=null):void
		{
			...
			initLoadingScreen();
			//Spawn Tile
			startLoadTiles(this.onGameLoadComplete)
		}
		
		private function startLoadTiles(loadCompleteEvent:Function=null):void
		{
			//Set Variables
			this.loadTileX=-WorldWidth
			this.loadTileY=-WorldHeight
			this.TotalLoadTiles=0
			this.LoadingScreen.element="Load Tiles: "
			this._loadCompleteEvent=loadCompleteEvent
			//Add Event Listener
			this.gameLoadingTimer.addEventListener(TimerEvent.TIMER,onTileLoading)
			//Start
		...
		private function onTileLoading(E:TimerEvent):void
		{
			...
			else
			{
				...
				else
				{
					...
					//Remove And Stop
					this.gameLoadingTimer.removeEventListener(TimerEvent.TIMER,onTileLoading)
		...
		private function initWorldVariables():void
		{
			...
			//World Size
			ShouldLoadTiles=(WorldWidth*2+1)*(WorldHeight*2+1);
			TotalLoadTiles=0
		...
		private function ResetWorld():void
		{
			...
			startLoadTiles(this.onWorldResetComplete)
		}
		
		private function onWorldResetComplete(E:TimerEvent=null)
		{
			//Show Entities_Sprite
...
class LoadScreen extends Sprite
{
	...
	private static const DEFAULT_TEXT:String="MainFont"
	private static const DEFAULT_TEXT_SIZE_TITLE:uint=64
	private static const DEFAULT_TEXT_SIZE_PERCENT:uint=32
	private static const DEFAULT_TEXT_COLOR_TITLE:uint=0x888888
	private static const DEFAULT_TEXT_COLOR_PERCENT:uint=0x888888
