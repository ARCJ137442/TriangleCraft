package TriangleCraft
{
	...
	public class Game extends Sprite
	{
		...
		public static const Version:String="Alpha 0.1.2 build 3";
		...
		private function onGameLoaded(E:Event=null):void
		{
			...
			onInit();
			//Set Pos
			this.x=-789//middleDisplayX;
			this.y=-90//middleDisplayY;
			//Spawn Tile
			spawnTiles()
			//Spawn Player
		...
		private function getCanMixBlocks(X,Y,pastVec:Vector.<String>=null):Vector.<Tile>
		{
			...
			var nowId:String=nowBlock.ID;
			var memoryVec:Vector.<String>=new Vector.<String>;
			...
			else if(pastVec!=null)
			{
				if(General.IsiA(Str,memoryVec))
				{
					return returnVec;
				}
			}
