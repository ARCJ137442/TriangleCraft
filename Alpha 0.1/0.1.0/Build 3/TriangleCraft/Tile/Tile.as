package TriangleCraft.Tile
{
	...
	public class Tile extends Sprite
	{
		...
		public static const Barrier:String=TileSystem.Barrier
		public static const Crystal_Wall:String=TileSystem.Crystal_Wall
		public static const Walls_Spawner:String=TileSystem.Walls_Spawner
		...
		public function SetDisplay():void
		{
			...
			if(hasAllowID)
			{
				...
				if(!TileSystem.needColor(ID))
				{
					...
					{
						this.Shape.Frame=TileSystem.getFrameByID(this.ID);
					}
