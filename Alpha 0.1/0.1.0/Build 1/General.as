package 
{
	...
	public class General
	{
		...
		public static function NumberToPercent(x:Number,includeFloat:Boolean=false):String
		{
			if(includeFloat)
			{
				return x*100+"%"
		...
		public static function NTP(x:Number,includeFloat:Boolean=false):String
		{
			return NumberToPercent(x,includeFloat)
		}
