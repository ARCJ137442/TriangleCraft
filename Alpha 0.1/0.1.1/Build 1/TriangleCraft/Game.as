package TriangleCraft
{
	...
	public class Game extends Sprite
	{
		...
		public static const Version:String="Alpha 0.1.1 build 1";
		...
		public function PlayerMove(player:Player,Rot:uint,Distance:uint):void
		{
			if(player!=null)
			{
				...
				//Use
				if(isTile(mX,mY)&&getTileTag(mX,mY).canUse)
				{
		...
		private function onBlockUse(X:int,Y:int,P:Mobile,Pos:uint,Id:String,Data:int,Tag:TileTag,Rot:int):void
		{
			switch(Id)
			{
