package TriangleCraft
{
	...
	public class Game extends Sprite
	{
		...
		public static const VERSION:String="Alpha 0.1.4 build 5";
		...
		{
			var rMode:uint=uint((int.MAX_VALUE+1)/8+this.loadTileY*8-V1*V2+V3*V4)
			var rBuff:Vector.<Number>=new <Number>[2,V1+Math.abs(V2-this.loadTileY),V3+Math.abs(V4+this.loadTileY)]
			var rSeed:uint=uint(this.WorldSpawnSeed-this.loadTileY+V1+V2+V3+V4)%rMode
