package TriangleCraft.Inventory
{
	...
	public class CraftRecipe
	{
		...
		public function testCanCraft(Inputs:Vector.<InventoryItem>):Boolean
		{
			...
			{
				if(!this._inputItems[i].isEqual(Inputs[i],this.ignoreCount,this.ignoreData,this.ignoreTag,this.ignoreRot))
				return false
			}
			return true
		}
		
		public function getCraftPercent(Inputs:Vector.<InventoryItem>):Number
		{
			return getCraftEquals(Inputs)/ITEM_SLOT_COUNT
		}
