	...
	public class Player extends Entity
	{
		...
		public function AddItem(Id:int,Count:uint=1,Data:int=0,Tag:Object=null):void
		{
			...
			else
			{
				...
				var ItemTag:Object={};
				ItemTag.canPass=Tag.canPass;
				ItemTag.canGet=Tag.canGet;
				ItemTag.canPlace=Tag.canPlace;
				ItemTag.canPlaceBy=Tag.canPlaceBy;
				ItemTag.canDestroy=Tag.canDestroy;
				ItemTag.canUse=Tag.canUse;
				ItemTag.canRotate=Tag.canRotate;
				Item={Id:Id,Count:Count,Data:Data,Tag:ItemTag};
			}
		...
		public function traceSelectedItem(Trace:Boolean=true,ShowItemTags:Boolean=true):String
		{
			...
			for (i in this.SelectedItem)
			{
				...
				else if (i=="Data"&&this.SelectedItem.Id==1)
				{
		...
		public static function CombinationToRGB(I:uint):Array
		{
			var r:int=(I>>16);
			var g:int=(I-(r<<16))>>8;
		...
		public function setPlayerPos(dir:uint):void
		{
			...
			if (this.SelectItemRevealed!=null&&!SelectItemRevealed.TileTag.canRotate)
			{
				this.SelectItemRevealed.setRotation(-dir+1)
			}
			else if(SelectItemRevealed.TileTag.canRotate)
			{
