package 
{
	...
	public class Game extends Sprite
	{
		...
		public static const Version:String="Alpha 0.0.3 build 3";
		...
		private function OnKeyDown(E:KeyboardEvent):void
		{
			...
			if(E.ctrlKey&&!E.shiftKey&&Code>48&&Code<57&&Code-48<=TileSystem.TotalTileCount)
			{
						...
						else
						{
							...
							player.InventorySelect>-1&&!block.Tag.canPlaceBy)
							{
								...
								if(blockDropItems is Array&&blockDropItems.length>0)
								{
									...
									{
										var giveItem:Array=blockDropItems[i]
										var giveId:String=giveItem[0]
										var giveCount:int=giveItem[1]
										var giveData:int=giveItem[2]
										var giveTag:TileTag=General.copyObject(giveItem[3])
