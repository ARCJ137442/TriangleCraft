package 
{
	...
	public class Player extends Entity
	{
		...
		//--------Inventory Function--------//
		public function AddItem(Id:int,Count:uint=1,Data:int=0,Tag:Object=null,Rot:int=0):void
		{
			...
			else
			{
				...
				var ItemTag:Object=General.copyObject(Tag)
				Item={Id:Id,Count:Count,Data:Data,Tag:ItemTag,Rot:Rot};
			}
