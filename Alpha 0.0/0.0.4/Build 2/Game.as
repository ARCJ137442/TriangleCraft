package 
{
	...
	public class Game extends Sprite
	{
		...
		public static const Version:String="Alpha 0.0.4 build 2";
		...
		{
			//Spawn New Player
			var player:Player=new Player(this,(X*tileSize),Y*tileSize,tileSize,tileSize,ID,color);
								...
								if(block.Tag.canGet)
								{
									if(blockDropItems is Array&&blockDropItems.length>0)
									{
										for(var i in blockDropItems)
										{
											...
											spawnItem(frontX,frontY,giveId,giveCount,giveData,giveTag,giveRot);
										}
									}
									else
									{
										//player.AddItem(blockID,1,blockData,blockTag,0);
										spawnItem(frontX,frontY,blockID,1,blockData,blockTag,0);
									}
								}
							}
							//Real Destroy
