package 
{
	...
	public class Game extends Sprite
	{
		...
		public static const Version:String="Alpha 0.0.4 build 1";
		...
		private function spawnPx(ID:uint):void
		{
			if(ID>0&&PlayerCount>0&&PlayerColorByID.length>0)
			{
				...
				if(P is Entity)
				{
					...
					this.Entities_Sprite.setChildIndex(Px,0);
				}
			}
			UpdateDebugText(2);
		}
		...
		{
			var item:Item=new Item(X,Y,Id,Count,Data,Tag,Rot)
